	...
	function _misc() {
		...
		if(jQuery('.box-flip').length > 0) {
			...
			jQuery('.box-flip').each(function() {
				if(jQuery(this).data('minHeight')) {
					_height = jQuery(this).data('minHeight');
				} else {
			...
			jQuery('.box-flip').hover(function() {
				jQuery(this).addClass('flip').find('[data-toggle="tooltip"]').tooltip('hide');
			},function(){
				jQuery(this).removeClass('flip').find('[data-toggle="tooltip"]').tooltip('hide');
			});
		}
                ...
                loadScript(plugin_path + 'select2/js/i18n/ru.js', function() {
                    _container.each(function() {
                        ...
                        if(!_t.hasClass('select2-custom')) {
                            if(_t.data('select2Options')) {
                                _t.select2(_t.data('select2Options'));
                            } else {
                                _t.select2();
                            }
                        }
