...
class FontAwesomeHelper
{
     ...
     * @return array
     */
    public static function getIcons($version = 5) {
        return $version == 5 ? [
            'fas fa-address-book',
            'fas fa-address-card',
            'fas fa-adjust',
     ...
     * @return array
     */
    public static function getIconsHtml($version = 5) {
        $icons = self::getIcons($version);
        $htmlIcons = [];
        foreach ($icons as $icon) {
            $htmlIcons[$icon] = Html::tag('i', null, ['class' => $icon]);
        }
    ...
    public static function getClass($icon) {
        $icons = array_flip(self::getIcons());
        if (isset($icons[$icon])) {
            return "fa fa-{$icon}";
        }
